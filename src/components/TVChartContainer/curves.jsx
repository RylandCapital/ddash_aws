...
import Datafeed from './datafeedcurves.js';
import { indicator } from './indicator_template_curves.js';
import userDb from "../../data/user_data"
...
export class TVChartContainer extends React.PureComponent {
	static defaultProps = {
		...
		clientId: 'Option-i',
		userId: 'RylandCapital'.concat(userDb()),
		fullscreen: false,
		autosize: true,
		studiesOverrides: {},
